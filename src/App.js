...
const QuizApp = () => {
  ...
  useEffect(() => {
    ...
    const questions = [
      ...
      {
        "type": "Databases",
        "question": "Consider a collection named products that stores information about products in a store. The collection has documents with fields like name, price, and category. Query: db.products.find({ price: { $gt: 10 } }, { name: 1, price: 1 }).sort({ price: 1 }); Data:{ \"_id\": \"prod1\", \"name\": \"Shirt\", \"price\": 15, \"category\": \"Clothing\" } { \"_id\": \"prod2\", \"name\": \"Hat\", \"price\": 8, \"category\": \"Accessories\" } { \"_id\": \"prod3\", \"name\": \"Trousers\", \"price\": 20, \"category\": \"Clothing\" } { \"_id\": \"prod4\", \"name\": \"Scarf\", \"price\": 5, \"category\": \"Accessories\" }",
        "options": [
      ...
      },
      {
        ...
        "options": ["Function definition is missing a colon (:)", "Function is missing a return statement", "Variable result is not defined inside the function", "All of the above"],
